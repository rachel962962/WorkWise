...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Schedule>(entity =>
            {
                ...
                entity.Property(e => e.AssignedHours).HasColumnType("decimal(5, 2)").HasColumnName("assigned_hours");
                entity.Property(e => e.FinishTime).HasColumnType("datetime").HasColumnName("finish_time");
                entity.Property(e => e.StartTime).HasColumnType("datetime").HasColumnName("start_time");
                entity.Property(e => e.Status).HasMaxLength(15).IsUnicode(false).HasDefaultValue("Scheduled").HasColumnName("status");
            ...
            modelBuilder.Entity<Task_>(entity =>
            {
                ...
                entity.Property(e => e.ComplexityLevel).HasMaxLength(10).IsUnicode(false).HasDefaultValue("Medium").HasColumnName("complexity_level");
                entity.Property(e => e.Deadline).HasColumnType("datetime").HasColumnName("deadline");
                entity.Property(e => e.Duration).HasColumnType("decimal(5, 2)").HasColumnName("duration");
                entity.Property(e => e.Name).HasMaxLength(100).IsUnicode(false).HasColumnName("name");
                entity.Property(e => e.PriorityLevel).HasColumnName("priority_level");
                entity.Property(e => e.RequiredWorkers).HasDefaultValue(1).HasColumnName("required_workers");
            ...
            modelBuilder.Entity<Worker>(entity =>
            {
                ...
                entity.Property(e => e.WorkerId).HasColumnName("worker_id");
                entity.Property(e => e.DailyHours).HasColumnType("decimal(4, 2)").HasColumnName("daily_hours");
                entity.Property(e => e.FirstName).HasMaxLength(50).IsUnicode(false).HasColumnName("first_name");
                entity.Property(e => e.LastName).HasMaxLength(50).IsUnicode(false).HasColumnName("last_name");
                entity.Property(e => e.MaxWeeklyHours).HasColumnType("decimal(5, 2)").HasColumnName("max_weekly_hours");
                entity.Property(e => e.TeamId).HasColumnName("team_id");
                ...
                entity.HasOne(d => d.User).WithMany(p => p.Workers)
                    ...
                    .HasConstraintName("FK__Workers__UserID__2EDAF651");
            });

            modelBuilder.Entity<User>(entity =>
            {
                entity.HasKey(e => e.UserId).HasName("PK__User__1788CCACBF7F5239");
                entity.ToTable("User");
                entity.HasIndex(e => e.Username, "UQ__User__536C85E48459362E").IsUnique();
                entity.Property(e => e.UserId).HasColumnName("UserID");
